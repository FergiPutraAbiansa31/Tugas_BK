...
$dokter = mysqli_query($mysqli, "SELECT dokter.id, nama, alamat, no_hp, nama_poli 
FROM dokter JOIN poli ON dokter.id_poli = poli.id");
?>
...
<body class="crm_body_bg">
                                    ...
                                    <div class="white_box_tittle list_header">
                                        ...
                                        <div class="box_right d-flex lms_block">
                                            ...
                                            <div class="add_button ms-2">
                                                <a href="tambah_dokter.php" class="btn_1">
                                                    Tambah
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_dokter.php?id=<?php echo $row['id']; ?>" class="btn btn-sm"><i class='fas fa-edit'></i> EDIT</a>
                                                            <a href="#" class="btn btn-sm" onclick="confirmDelete('<?php echo $row['id']; ?>', '<?php echo $row['nama']; ?>')"><i class='ti-trash'></i>
                                                                HAPUS
                                                            </a>
                                                        </td>
                                                    </tr>
    ...
    <script>
        function confirmDelete(id, nama) {
            var confirmDelete = confirm("Anda yakin akan menghapus '" + nama + "'?");
            if (confirmDelete) {
                window.location.href = "proses_hapus_dokter.php?id=" + id;
            }
        }
    </script>
</body>
