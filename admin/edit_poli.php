...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = mysqli_query($mysqli, "SELECT * FROM poli WHERE id = '$id'");
                                ...
                                <div class="col-lg-6">
                                    <div class="modal-content cs_modal">
                                        <div class="modal-header justify-content-center theme_bg_1">
                                            <h5 class="modal-title text_white">Edit Poli</h5>
                                        </div>
                                        <div class="modal-body">
                                            <form action="proses_edit_poli.php" method="post">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_poli" name="nama_poli" value="<?php echo $poli['nama_poli']; ?>" required>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="keterangan" class="form-label">Keterangan</label>
                                                    <input type="text" class="form-control" id="keterangan" name="keterangan" value="<?php echo $poli['keterangan']; ?>" required>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-3">
