                                ...
                                <div class="col-lg-6">
                                    <div class="modal-content cs_modal">
                                        <div class="modal-header justify-content-center theme_bg_1">
                                            <h5 class="modal-title text_white">Edit Pasien</h5>
                                        </div>
                                        <div class="modal-body">
                                            <form action="proses_edit_pasien.php" method="post">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="no_ktp" name="no_ktp" value="<?php echo $pasien['no_ktp'] ?>" required>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="no_hp" class="form-label">No HP</label>
                                                    <input type="number" class="form-control" id="no_hp" name="no_hp" value="<?php echo $pasien['no_hp'] ?>" required>
                                                </div>
                                                <div class="form-group mb-3">
