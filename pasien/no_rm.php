            ...
            <div class="col-lg-6 mx-5 py-5 px-5">
                <div class="modal-content cs_modal">
                    <div class="modal-header justify-content-center theme_bg_1">
                        <h5 class="modal-title text_white">Registrasi Berhasil</h5>
                    </div>
                    <div class="modal-body">
                        <h6 class="text-center">Nomor Rekam Medis Anda</h6><br/>
                        <h2 class="text-center"><?php echo isset($_GET['rm']) ? htmlspecialchars($_GET['rm']) : ''; ?></h2>
                        <p class="text-center text-muted"style="font: size 5px;">*Harap ingat Nomor Rekam Medis Anda untuk mendaftar poli.</p>
                        <div class="row">
                            <div class="col-md-6">
                                <a href="../index.php" class="btn btn_1 btn-block">Back</a>
                            </div>
                            <div class="col-md-6">
                                <a href="daftar_poli.php" class="btn btn_1 btn-block">Lanjut Daftar Poli</a>
                            </div>
                        </div>
                    </div>
                </div>
