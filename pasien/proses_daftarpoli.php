<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (mysqli_num_rows($queryCekData)>0) {
            ...
            if ($queryDaftarPoli) {
                echo '<script>alert("Berhasil mendaftar poli");window.location.href="daftar_poli.php";</script>';
            }
            else{
                echo '<script>alert("Gagal mendaftar poli");window.location.href="daftar_poli.php";</script>';
            }
        }
        else{
            $noAntrian = 1;
